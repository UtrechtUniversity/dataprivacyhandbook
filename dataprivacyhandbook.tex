...
\hypersetup{
  ...
  pdfauthor={Utrecht University \textbar{} Last updated: 2023-05-22},
  hidelinks,
...
\includepdf{img/FPF_Visual-Guide-to-Practical-Data-DeID.pdf}
...
\hypertarget{synthetic-data-implications}{%
\subsection{Implications for research}\label{synthetic-data-implications}}
...
\item
  ...
  \textbf{privacy-utility spectrum}. Whether the synthetic dataset still contains
  ...
  \href{https://www.ons.gov.uk/methodology/methodologicalpublications/generalmethodology/onsworkingpaperseries/onsmethodologyworkingpaperseriesnumber16syntheticdatapilot}{UK Office for National Statistics}.
\item
  Synthetic data is sometimes used in conjunction with
  \protect\hyperlink{differential-privacy}{Differential Privacy}, which can help to numerically
...
\addcontentsline{toc}{part}{Use Cases}
