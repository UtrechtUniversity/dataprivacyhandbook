...
\hypertarget{where-should-i-store-personal-data}{%
\section{Where should I store personal data?}\label{where-should-i-store-personal-data}}
...
\hypertarget{requirements-for-a-suitable-storage-medium}{%
\section{Requirements for a suitable storage medium}\label{requirements-for-a-suitable-storage-medium}}
...
\hypertarget{how-should-i-store-personal-data}{%
\section{How should I store personal data?}\label{how-should-i-store-personal-data}}
...
\hypertarget{for-how-long-should-i-store-personal-data}{%
\section{For how long should I store personal data?}\label{for-how-long-should-i-store-personal-data}}

\textbf{You can only store personal data for as long as is necessary for your
