...
([art. 15](https://gdpr-info.eu/art-15-gdpr/){target="_blank"}), the right to 
rectification ([art. 16](https://gdpr-info.eu/art-16-gdpr/){target="_blank"}), 
and the right to restriction of processing
([art. 18](https://gdpr-info.eu/art-18-gdpr/){target="_blank"}), so that data 
...
[information to data subjects](#privacy-notices), you have to explicitly 
