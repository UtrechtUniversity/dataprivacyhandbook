...
<details><summary><b>Further processing for research purposes</b></summary>
  <div><p>This is a derogation in the GDPR that enables personal data to be further 
  processed (e.g., shared) for any *scientific research purposes*, without requiring 
  a new legal basis, as long as sufficient safeguards are in place to protect the data 
  ...
  are not shared for scientific research purposes, then a new legal basis *is* 
  required, except if the new purpose is *compatible* with the original purpose.</p> 
  <p>**Note**: There is ongoing discussion whether you can rely on this 
  derogation if you used consent to collect the data, especially if those data 
  are of [special categories](#special-types-personal-data): sharing that falls 
  ...
  interest, legitimate interest).</p>
  </div>
</details>
...
data confidentially and that clarifies each party’s responsibilities. 
...
- If you will transfer personal data 
[outside of the European Economic Area](#third-country-transfer) (EEA),
consider which measures are needed, especially if the relevant country does not 
have an 
