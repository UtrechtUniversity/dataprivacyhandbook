...
<details>
  <summary><i>Examples (click to expand)</i></summary>
    <div>name, image, video recording, audio recording, patient number, IP address, 
    email address, phone number, location data, social media data<br></div>
</details>
...
<details>
  <summary><i>Examples</i></summary>
  <div>Linkage is often possible with demographic information (age, 
...
please contact your [privacy officer or data manager](#support).
