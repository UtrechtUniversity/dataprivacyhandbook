...
<details><summary><b>Examples</b></summary>
  ...
  email address, phone number, location data, social media data <br>
</details>
...
- It is possible to **link records** relating to an individual or to 
**infer information** about an individual. This can happen when combining 
...
data, even if the data in your dataset are not identifiable by themselves.<br>
<details><summary><b>Examples</b></summary>
