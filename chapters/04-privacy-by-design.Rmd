...
(<a href="https://gdpr-info.eu/art-25-gdpr/" target="_blank">art. 25</a>) are 
important:
...
need to perform a more elaborate <a href="#dpia">Data Protection Impact Assessment</a>.

<img src="img/privacy-research-cycle.png" alt="Privacy in the research cycle. 
...
(<a href="https://www.cs.ru.nl/~jhh/publications/pds-booklet.pdf" target="_blank">Hoepman, 2022</a>) 
...
<img src="img/pbd-strategies.png" alt="Eight Privacy by Design strategies which
can also be applied in research projects: minimise, separate, abstract, hide, 
inform, control, enforce, and demonstrate" height="80%"/>

## Data-oriented strategies {#data-oriented-strategies}
...
"<a href="https://www.qualtrics.com/support/survey-platform/survey-module/survey-options/survey-protection/#AnonymizingResponses" target="_blank">Anonymize Responses</a>" 
option.
...
<a href="#data-storage">Storage chapter</a>). Use directly identifying 
...
- <a href="#pseudonymisation-anonymisation">Pseudonymising or anonymising</a> 
...
- Applying <a href="#secure-computing">secure computing</a> techniques, where 
...
- <a href="#pseudonymisation-anonymisation">Anonymising or pseudonymising</a> 
the data.
...
data points.
- <a href="#synthetic-data">Synthesising</a> the data, e.g., for sharing trends 
...
- Using <a href="#encryption">encryption</a>, <a href="#pseudonymisation-anonymisation">hashing</a> or 
<a href="https://students.uu.nl/en/practical-information/it-facilities/information-security/information-security-secure-access-choosing-a-secure-password" target="_blank">strong passwords</a> 
...
personal data.
- Applying privacy models like <a href="#differential-privacy">Differential Privacy</a>,
...
## Process-oriented strategies {#process-oriented-strategies}
### Inform
...
<a href="#privacy-notices">information letter or privacy notice</a> on a project 
website.
...
exercise their <a href="#data-subject-rights">data subject rights</a>.
...
- Using only 
<a href="https://tools.uu.nl/" target="_blank">Utrecht University-approved tools</a> 
to collect, <a href="data-storage">store</a>, analyse and <a href="data-sharing-collaboration">share</a> 
personal data. 
- Entering into <a href="#agreements">agreements</a> with third parties if they 
...
<a href="https://intranet.uu.nl/en/knowledgebase/what-is-a-personal-data-breach" target="_blank">data breaches</a>. 
At UU, contact the <a href="https://intranet.uu.nl/en/security/information-security-computer-misuse-or-report-incident-cert" target="_blank">Computer Emergency Response Team</a>. 
...
- Performing a <a href="#privacy-scan">Privacy Scan</a> and storing it 
alongside the personal data.
- Performing a <a href="#dpia">Data Protection Impact Assessment (DPIA)</a> for 
