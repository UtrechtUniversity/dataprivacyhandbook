...
"<a href="https://www.qualtrics.com/support/survey-platform/survey-module/survey-options/survey-protection/#AnonymizingResponses" target="_blank">Anonymize Responses</a>" option.
...
<a href="#data-storage">Storage chapter</a>).

### Separate
Separate the processing of different types of personal data as much as possible, 
for example by:

- <a href="#pseudonymisation-anonymisation">Pseudonymisation</a>: Store directly 
...
- <a href="#pseudonymisation-anonymisation">Anonymising or pseudonymising</a> the data.
...
<a href="https://students.uu.nl/en/practical-information/it-facilities/information-security/information-security-secure-access-choosing-a-secure-password" target="_blank">strong passwords</a> to protect data. Keep in mind that you 
