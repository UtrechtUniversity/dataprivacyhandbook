...
[MetaSynth](https://github.com/sodascience/metasynth){target="_blank"} ([workshop](https://github.com/sodascience/workshop-syntheticdata-osf2022){target="_blank"}) 
...
<p style="text-align:center;"><img src="https://www.cell.com/cms/attachment/3bdcf4ba-3f26-474b-ac54-534ebbe4af52/gr1.jpg"
...
workflow. The following steps take palce at the participant's device: 
...
([D3I](https://www.uu.nl/en/news/the-board-of-the-pdi-ssh-foundation-honours-applications-in-the-call-digital-infrastructure-ssh){target="_blank"})
project. 
