...
[Glossary](#glossary)). Click a term to see the definition.

<details>
  <summary><b>Data subject</b></summary>
    <div>A living individual who can be identified directly or indirectly through 
      personal data. In a research setting, this would be the individual whose 
      personal data is being processed (see below for the definition of processing).</div>
</details>
...
<details>
  ...
  <div>Any information pertaining to the data subject which reveals any of the below categories:
  <ul>
  ...
  the exceptions of [article 9](https://gdpr-info.eu/art-9-gdpr/){target="_blank"} 
  ...
  <p>
  Contact your [privacy officer](#support) if you wish to process special categories of personal data.</p></div>
</details>
...
<details>
  ...
  [data processing agreement](#data-processing-agreement) in place.
  </div>
</details>
...
<details>
  ...
  bases which are explained further [in this chapter](#legal-basis).
  </div>
</details>

<details>
  <summary><b>Anonymous data</b></summary>
  <div>Any data where an individual is irreversibly de-identified, both directly 
  ...
  [Opinion 05/2014 on Anonymisation Techniques](https://ec.europa.eu/justice/article-29/documentation/opinion-recommendation/files/2014/wp216_en.pdf){target="_blank"} 
...
<img src="img/gdpr-principles.png" title="The key principles of the GDPR" 
alt="Overview of the principles, denoted in text on a yellow background, with an 
...
[fg@uu.nl](mailto:fg@uu.nl){.email} (the Data Protection Officer) for 
