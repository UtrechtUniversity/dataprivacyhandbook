...
- Make sure you have a <a href="#legal-basis">legal basis</a> to process the 
...
<a href="#privacy-by-design">privacy by design</a> into your project from the start.
- Make sure your data subjects can exercise their 
<a href="#data-subject-rights">data subjects' rights</a>, and they know how to 
do so.
...
<details>
  ...
  <small> The General Data Protection Regulation (GDPR) regulates what we can 
...
- you are processing <a href="#privacy-by-design">personal data</a> 
(material scope, <a href="https://gdpr-info.eu/art-2-gdpr/" target="_blank">art. 2</a>).
- the controller or processor of the data *resides* in the EEA (territorial 
scope, <a href="https://gdpr-info.eu/art-3-gdpr/" target="_blank">art. 3</a>).
...
You can read more in the chapter <a href="#personal-data">What are personal data?</a>.
:::
...
<a href="#glossary">Definitions</a>). Click a term to see the definition.
...
<details>
  ...
  <a href="#personal-data">What are personal data?</a>.
  </p>
</details>
...
<details>
  ...
  The processing of these categories of data is <b>prohibited</b>, unless one of 
  the exceptions of <a href="https://gdpr-info.eu/art-9-gdpr/" target="_blank">Article 9</a> 
  applies. For example, an exception applies when:
  <ul>
    <li>the data subject has provided explicit consent to process these data for 
  ...
  <p>
  Contact your <a href="https://intranet.uu.nl/en/knowledgebase/contact-privacy" target="_blank">privacy 
  officer</a> if you wish to process special categories of personal data.</p>
</details>
...
<details>
  ...
  influence on <b>why</b> and <b>how</b> personal data are processed. On an 
...
<details>
  ...
  bases which are explained further <a href="#legal-basis">in this chapter</a>.
  </p>
</details>
...
<details>
  ...
  <ul>
    <li>by combining variables or datasets (e.g., a combination of date of birth, 
    gender and birthplace, or the combination of a dataset with its name-number key)</li>
    <li>via inference, i.e., when you can deduce who the data are about (e.g., 
    when profession is Dutch prime minister, it is clear who the data is about)</li>
    <li>by singling out a single subject, such as through unique data points 
    e.g., someone who is 210 cm tall is relatively easy to identify)</li>
  </ul>
  <p>
...
<details>
  ...
  <p>
  Personal data that cannot lead to identification <i>without additional 
  information</i>, such as a key file linking pseudonyms to names. This additional 
...
<a href="#privacy-by-design">next chapter</a> will describe how to implement these 
...
<img src="img/gdpr-principles.png" alt="Principles of the GDPR: Lawful, fair and 
transparent, Purpose limitation, Data minimisation, Accuracy, Storage limitation, 
Integrity and Confidentiality, and Accountability" height="80%"/>
...
<ol>
  ...
  analysis, sharing) have a <a href="#legal-basis">legal basis</a>. Ideally, 
  ...
  Be transparent in the <a href="#privacy-notices">communication to your data subjects</a> 
...
the <a href="#data-subject-rights">right</a> to request that inaccurate or 
incomplete data be removed or rectified within 30 days.

#### 5. Storage limitation

You can only <a href="#data-storage">store personal data</a> for as long as is 
...
apropriate <a href="#privacy-by-design">organisational and technical measures</a>.
...
<a href="#privacy-by-design">processing register</a> and 
<a href="#privacy-notices">communicated to data subjects</a>. There are 6 possible 
  ...
  <li>
    <details>
      ...
      <p>
        ...
        refer to the <a href="#informed-consent-forms">Informed consent section</a> 
    ...
    <details>
      ...
      <p>
        ...
        to clearly benefit society or fulfills a public task. In essence, public 
        interest can be used as a legal basis in research, because conducting 
        research at the university has been officially recognised in the Higher 
        Education and Scientific Research Act to be a public task. Public 
        interest is often used when consent is not a good option. For example, 
        it may be impossible or impractical to obtain consent when performing 
        public observations or social media research. Or when participants 
        actually do not have a free choice, such as in clinical trials when 
        participants would experience significant disadvantages when not 
        participating.
      </p>
      <p>
        ...
        <a href="https://intranet.uu.nl/kennisbank/contactpersonen-privacy" target="_blank">privacy officer</a> 
  ...
  <li>
    <details>
      ...
      <p>
        ...
        <a href="#legitimate-interest-assessment">Legitimate interest assessment</a>. 
...
It may happen that you want to process personal data for similar, but other 
purposes than previously specified (e.g., because you formulated an additional
research question), or you want to reuse personal data previously collected for
other purposes in your research. In this case, it may be possible to make use of 
<a href="https://gdpr-info.eu/art-5-gdpr/" target="_blank">article 5(1)(b)</a>,
which states that "further processing for [...] scientific purposes shall [...] 
not be considered to be incompabitle with the initial purposes". Basically, this 
means that you can reuse personal data that were previously collected for other 
purposes for scientific research purposes, but provided that you put in place 
sufficient safeguards to protect the personal data 
(<a href="https://gdpr-info.eu/art-89-gdpr/" target="_blank">art. 89</a>). This 
is not a legal basis, but can still function as a way to legitimise processing 
personal data for research purposes. Always discuss with a privacy officer if
this article can be applied to your project!
...
<ol>
  <li>
    <details>
      ...
      personal data (a.o. <a href="https://gdpr-info.eu/art-12-gdpr/" target="_blank">art. 12</a>). 
      This usually happens via a <a href="#privacy-notices">privacy notice or information letter</a>. This right 
  ...
  <li>
    <details>
      ...
      (<a href="https://gdpr-info.eu/art-15-gdpr/" target="_blank">art. 15</a>).
    </details>
  </li>
  <li>
    <details>
  ...
  <li>
    <details>
      ...
      <a href="https://gdpr-info.eu/art-17-gdpr/" target="_blank">art. 17</a>). 
  ...
  <li>
    <details>
      ...
      (<a href="https://gdpr-info.eu/art-18-gdpr/" target="_blank">art. 18</a>), 
  ...
  <li>
    <details>
      ...
      another party (<a href="https://gdpr-info.eu/art-20-gdpr/" target="_blank">art. 20</a>).
    </details>
  </li>
  <li>
    <details>
      ...
      or public interest (<a href="https://gdpr-info.eu/art-21-gdpr/" target="_blank">art. 21</a>). 
...
<a href="#privacy-notices">privacy notice</a> or information letter, which states 
...
[privacy@uu.nl](mailto:privacy@uu.nl){.email} (the Data Protection Officer) for 
...
(<a href="https://gdpr-info.eu/art-11-gdpr/" target="_blank">art. 11</a>). 
