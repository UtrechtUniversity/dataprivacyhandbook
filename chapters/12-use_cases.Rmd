...
<button class = "button" role = "button" name="Before" onclick="window.open('https://utrechtuniversity.github.io/dataprivacyhandbook/assets/Use-case-minimisation-Before.pdf','_blank');">Before minimisation</button>
<button class = "button" role = "button" name="After" onclick="window.open('https://utrechtuniversity.github.io/dataprivacyhandbook/assets/Use-case-minimisation-After.pdf','_blank');">After minimisation</button>
