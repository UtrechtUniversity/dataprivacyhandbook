...
link-citations: yes
description: |
  "The Data Privacy Handbook is being developed as a readable and practical 
  resource for researchers and research support staff to address data 
  privacy-related issues that come up during the research cycle."
output:
  html_document:
    toc: true
    toc_depth: 4
