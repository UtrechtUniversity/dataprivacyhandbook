...
activities. Assuming that you have a legal basis  to store personal data, you 
then need to:
...
These aspects of personal data storage are discussed in this chapter. 

### Chapter summary

**Where should I store personal data?**

- Use a medium that has been approved by your institution (UU: use the
...
e.g., restrict access, encrypt data, specify responsibilities, etc.
- Store (personal) data preferably in a machine-readable format.

**For how long should I store personal data?**

- Delete or fully anonymise personal data when they are no longer necessary, 
and preferably determine when to do so in advance.
- In research, you can archive personal data for valid ation purposes for a 
longer period of time, e.g., 10 years or longer.
...
digital research data via the <a href="https://tools.uu.nl/storagefinder/" target = "_blank">Storage Finder</a>
...
- **Do not store personal research data on public cloud services**, e.g., Google 
...
## Requirements for a suitable storage medium
...
country with an adequate level of data protection.
...
The storage medium should employ good security practices, such as regular back-up 
...
different types of personal data, encrypt, anonymise or pseudonymise the data, etc.
...
**You can only store personal data for as long as is necessary for your 
prespecified (research) purposes. Afterwards, you have to fully anonymise or 
delete the data. For all types of data in your project, it is wise to 
formulate such a data retention policy in advance and communicate it to data 
subjects, so that it is clear for you, your collaborators, and your data subjects 
...
10 years (<a href = "https://www.uu.nl/sites/default/files/university_policy_framework_for_research_data_utrecht_university_-_january_2016.pdf" target = "_blank">UU research data policy</a>). 
...
This also implies that documentation about the legal basis used (e.g., consent forms) 
should be kept during that time, so that GDPR compliance can be demonstrated.
...
If you want to change the storage term you initially set for your personal data, 
please contact your 
<a href = "https://intranet.uu.nl/en/knowledgebase/contact-privacy" target = "_blank">privacy officer</a>.
...
"<a href = "https://www.uu.nl/en/research/research-data-management/guides/storing-and-preserving-data" target = "_blank">Storing 
and preserving data</a>".
